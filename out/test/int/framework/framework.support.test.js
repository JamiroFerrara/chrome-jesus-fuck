...
suite('Test framework tests', () => {
    test('Should correctly find breakpoint labels in test source files', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('Should correctly find block comment breakpoint labels in test source files', () => __awaiter(void 0, void 0, void 0, function* () {
        let labels = yield labels_1.loadProjectLabels('./testdata');
