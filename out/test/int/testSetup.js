...
exports.killAllChromesOnWin32 = exports.teardown = exports.setupWithTitle = exports.setup = exports.DATA_ROOT = exports.PROJECT_ROOT = exports.lowercaseDriveLetterDirname = exports.isWindows = exports.isThisV1 = exports.isThisV2 = void 0;
...
function setupWithTitle(testTitle, port, launchProps) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const debugClient = yield ts.setup({ entryPoint: DEBUG_ADAPTER, type: 'legacy-chrome', patchLaunchArgs: args => patchLaunchArgs(args, testTitle), port: port });
