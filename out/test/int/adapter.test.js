...
suite('Chrome Debug Adapter etc', () => {
    ...
    suite('launch', () => {
        ...
        test('Should hit breakpoint even if webRoot has unexpected case all lowercase for VisualStudio', () => __awaiter(void 0, void 0, void 0, function* () {
            const breakFile = path.join(testProjectRoot, 'src/app.ts');
            const DEBUGGER_LINE = 2;
        ...
        test('Should hit breakpoint even if webRoot has unexpected case all uppercase for VisualStudio', () => __awaiter(void 0, void 0, void 0, function* () {
            const breakFile = path.join(testProjectRoot, 'src/app.ts');
            const DEBUGGER_LINE = 2;
            yield dc.initializeRequest({
                adapterID: 'legacy-chrome',
         ...
         */
        test('Should throw error when launching if chrome debug port is in use', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('Should launch successfully on port 0', () => __awaiter(void 0, void 0, void 0, function* () {
            // browser already launched to the default port, and navigated away from about:blank
        ...
        test('Should launch successfully on port 0, even when a browser instance is already running', () => __awaiter(void 0, void 0, void 0, function* () {
            // browser already launched to the default port, and navigated away from about:blank
            const remoteDebuggingPort = 0;
