...
suite('Breakpoints', () => {
    ...
    suite('Column BPs', () => {
        test('Column BP is hit on correct column', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('Multiple column BPs are hit on correct columns', () => __awaiter(void 0, void 0, void 0, function* () {
            const testProjectRoot = path.join(DATA_ROOT, 'columns');
            const scriptPath = path.join(testProjectRoot, 'src/script.ts');
            server = http_server_1.createServer({ root: testProjectRoot });
            server.listen(7890);
        ...
        test('BP col is adjusted to correct col', () => __awaiter(void 0, void 0, void 0, function* () {
            const testProjectRoot = path.join(DATA_ROOT, 'columns');
            const scriptPath = path.join(testProjectRoot, 'src/script.ts');
            server = http_server_1.createServer({ root: testProjectRoot });
            server.listen(7890);
