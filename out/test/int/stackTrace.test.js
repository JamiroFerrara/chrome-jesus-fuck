...
puppeteerSuite_1.puppeteerSuite('Stack Traces', TEST_SPEC, (suiteContext) => {
    puppeteerSuite_1.puppeteerTest('Stack trace is generated with no formatting', suiteContext, (_context, page) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    puppeteerSuite_1.puppeteerTest('Stack trace is generated with module formatting', suiteContext, (_context, page) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    puppeteerSuite_1.puppeteerTest('Stack trace is generated with line formatting', suiteContext, (_context, page) => __awaiter(void 0, void 0, void 0, function* () {
        yield validateStackTrace({
            suiteContext: suiteContext,
            page: page,
            breakPointLabel: 'stackTraceBreakpoint',
    ...
    puppeteerSuite_1.puppeteerTest('Stack trace is generated with all formatting', suiteContext, (_context, page) => __awaiter(void 0, void 0, void 0, function* () {
        const url = suiteContext.launchProject.url;
        yield validateStackTrace({
            suiteContext: suiteContext,
            page: page,
