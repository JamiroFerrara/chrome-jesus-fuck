...
puppeteerSuite_1.puppeteerSuite('Hit count breakpoints on a React project', resourceProjects_1.reactTestSpecification, (suiteContext) => {
    puppeteerSuite_1.puppeteerTest("Hit count breakpoint = 3 pauses on the button's 3rd click", suiteContext, (_context, page) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    puppeteerSuite_1.puppeteerTest("Hit count breakpoints = 3, = 4 and = 5 pause on the button's 3rd, 4th and 5th clicks", suiteContext, (_context, page) => __awaiter(void 0, void 0, void 0, function* () {
        const incBtn = yield page.waitForSelector('#incrementBtn');
        const breakpoints = breakpointsWizard_1.BreakpointsWizard.create(suiteContext.debugClient, resourceProjects_1.reactTestSpecification);
        const counterBreakpoints = breakpoints.at('Counter.jsx');
        const setStateBreakpoint = yield counterBreakpoints.hitCountBreakpoint({
    ...
    puppeteerSuite_1.puppeteerTest("Hit count breakpoints = 3, = 4 and = 5 set in batch pause on the button's 3rd, 4th and 5th clicks", suiteContext, (_context, page) => __awaiter(void 0, void 0, void 0, function* () {
        const incBtn = yield page.waitForSelector('#incrementBtn');
        const breakpoints = breakpointsWizard_1.BreakpointsWizard.create(suiteContext.debugClient, resourceProjects_1.reactTestSpecification);
        const counterBreakpoints = breakpoints.at('Counter.jsx');
        const { setStateBreakpoint, stepInBreakpoint, setNewValBreakpoint } = yield counterBreakpoints.batch(() => __awaiter(void 0, void 0, void 0, function* () {
            return ({
        ...
        yield incBtn.click();
        yield breakpoints.waitAndAssertNoMoreEvents();
        yield counterBreakpoints.batch(() => __awaiter(void 0, void 0, void 0, function* () {
            yield setStateBreakpoint.unset();
            yield setNewValBreakpoint.unset();
            yield stepInBreakpoint.unset();
        }));
