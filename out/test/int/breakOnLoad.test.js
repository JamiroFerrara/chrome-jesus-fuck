...
suite('BreakOnLoad', () => {
    ...
    suite('Instrument Webpack Project', () => {
        ...
        test('Hits a single breakpoint in a file on load', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('Hits multiple breakpoints in a file on load', () => __awaiter(void 0, void 0, void 0, function* () {
            const testProjectRoot = path.join(DATA_ROOT, 'breakOnLoad_webpack');
            const scriptPath = path.join(testProjectRoot, 'src/script.js');
            server = http_server_1.createServer({ root: testProjectRoot });
            server.listen(7890);
        ...
        test('Hits a breakpoint at (1,1) in a file on load', () => __awaiter(void 0, void 0, void 0, function* () {
            const testProjectRoot = path.join(DATA_ROOT, 'breakOnLoad_webpack');
            const scriptPath = path.join(testProjectRoot, 'src/script.js');
            server = http_server_1.createServer({ root: testProjectRoot });
            server.listen(7890);
    ...
    suite('BreakOnLoad Disabled (strategy: off)', () => {
        ...
        test('Does not hit a breakpoint in a file on load', () => __awaiter(void 0, void 0, void 0, function* () {
            const testProjectRoot = path.join(DATA_ROOT, 'breakOnLoad_sourceMaps');
            const scriptPath = path.join(testProjectRoot, 'src/script.ts');
            server = http_server_1.createServer({ root: testProjectRoot });
            server.listen(7890);
